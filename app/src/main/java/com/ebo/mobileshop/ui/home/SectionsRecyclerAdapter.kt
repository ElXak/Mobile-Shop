...
class SectionsRecyclerAdapter(
    val context: Context,
    val sections: List<SelectedSection>,
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val sectionImage: CircleImageView = itemView.findViewById(R.id.section_image)
    }
...
*/
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        with(holder) {
            ...
            nameText.let {
                it.text = section.name
                it.contentDescription = section.description
            }
            // sets the image section.pictureUrl into sectionImage
            Glide.with(context)
                .load(section.pictureUrl)
                .into(sectionImage)
            ...
            holder.itemView.setOnClickListener {
                ...
                itemListener.onSectionItemClick(section)
            }
        }
    }
    ...
    interface ItemListener {
        fun onSectionItemClick(section: SelectedSection)
    }
